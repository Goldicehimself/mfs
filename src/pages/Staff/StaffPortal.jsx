    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2 mb-3 text-sm">
        ...
        <div>
          ...
          <p className="font-semibold text-amber-600">⭐ {staff.rating}</p>
        </div>
      </div>
...
export default function StaffPortal() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Staff Portal</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          icon={Award}
          label="Team Rating"
          value={`${mockStaffData.department.teamRating}⭐`}
          color="amber"
        />
      </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 p-4 rounded-lg border border-indigo-200 dark:border-indigo-700/50">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-amber-600">⭐ {selectedStaff.rating}/5.0</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Certifications</p>
                      <p className="text-xl font-bold text-emerald-600">🏆 {selectedStaff.certifications}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Completed Orders</p>
                      <p className="text-xl font-bold text-blue-600">✓ {selectedStaff.completedOrders}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded">
                    ...
                    <p className="text-xl font-bold text-amber-600">{selectedStaff.rating}⭐</p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="wo-001">WO-001: HVAC Maintenance</SelectItem>
                      <SelectItem value="wo-002">WO-002: Plumbing Repair</SelectItem>
                      <SelectItem value="wo-003">WO-003: Electrical Check</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
              ...
              <div className="flex gap-3 p-6 border-t border-gray-200 dark:border-zinc-800">
                ...
                <Button
                  className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white"
                  onClick={() => {
                    alert(`✓ Work order assigned to ${selectedStaff.name}`);
